...
public class PlayerLeaderboardBlock extends Block {

    public PlayerLeaderboardBlock(Settings settings) {
        super(settings);
    }
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        ...
        textDisplayEntityMixin.setHologramTextPlaceholder("""
                    ...
                    1st: <gold>★</gold> %ninelives:player_score 1% %ninelives:player_score_name 1%
                    2nd: <gold>★</gold> %ninelives:player_score 2% %ninelives:player_score_name 2%
                    3rd: <gold>★</gold> %ninelives:player_score 3% %ninelives:player_score_name 3%
                    4th: <gold>★</gold> %ninelives:player_score 4% %ninelives:player_score_name 4%
                    5th: <gold>★</gold> %ninelives:player_score 5% %ninelives:player_score_name 5%
                    6th: <gold>★</gold> %ninelives:player_score 6% %ninelives:player_score_name 6%
                    7th: <gold>★</gold> %ninelives:player_score 7% %ninelives:player_score_name 7%
                    8th: <gold>★</gold> %ninelives:player_score 8% %ninelives:player_score_name 8%
                    9th: <gold>★</gold> %ninelives:player_score 9% %ninelives:player_score_name 9%
                    10th: <gold>★</gold> %ninelives:player_score 10% %ninelives:player_score_name 10%
                    <color:#555555><strikethrough></strikethrough></color>
                    """);
