...
public class API {
    public static void main(String[] args) {
        ...
        get("/playerteams", (req, res) -> "{ \"Sakura Syndicate\": [\"TheBayker\", \"Elainettie\", \"SocketKat\"], \"The Greybeards\": [\"Danbearpig82\", \"PyfroAUS\", \"Sir_Laughalot\"],    \"GingerBread Men\": [\"FabledDayes\", \"GaymerSalsa\", \"TheWickedWeasel\"],    \"Creeper Toes\": [\"Blundingen\", \"Noesshie\", \"Tadpole_Milk_\"], \"Burgundy Bad Boys\": [\"LauranceTheLorax\", \"LawlessFern\", \"KnightlyInfinite\"],    \"The Magenta Menaces\": [\"Kayoss_Taz\", \"MommaMelissa14\", \"Corrupted_Tree\"],    \"Mist Wraiths\": [\"TheXpNetwork\", \"OfftheRailsIR\", \"Givized13\"],    \"Solar Squadron\": [\"Manky_Hamster\", \"Mefallit\", \"Chipz_N_Dipz\"],    \"Paint it Black\": [\"RSNFreud\", \"SiegeTheDay\", \"BlackClad1derer\"],    \"Busta Limes\": [\"GagetGaming\", \"Mistyjoy11\", \"Multibobob\"],    \"O-RNG-EE CRUSH\": [\"MCTCReese\", \"AggroNinja89\", \"NarcoleptiCheeta\"],    \"The 9ice Crew\": [\"Magganna\", \"Sorgan_D\", \"CelticDragoness\"],    \"Cyanide Squad\": [\"Sling_n_Stone\", \"Shortzelda22\", \"ShallowStack\"],    \"Queso Blanco\": [\"GreatLakesGirl\", \"DragonNebula42\", \"Theperfectshot3\"],    \"The Smurfs\": [\"ZeeBeeBlue\", \"Clutchypoo\", \"SonOfAlister\"],    \"Purple Pirates\": [\"oISketcHIo\", \"Linahun\", \"VannahVan16\"]}");
    }
